...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull TextView appTitle,
      @NonNull ProgressBar loadingIndicator, @NonNull LinearLayout logoContainer,
      @NonNull ConstraintLayout main, @NonNull TextView subtitle) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, appTitle, loadingIndicator,
          logoContainer, main, subtitle);
    }
